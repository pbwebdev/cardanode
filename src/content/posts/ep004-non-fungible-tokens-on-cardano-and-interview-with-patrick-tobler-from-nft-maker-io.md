---
title: "EP004 Non Fungible Tokens on Cardano and Interview with Patrick Tobler from NFT-Maker.io"
slug: "ep004-non-fungible-tokens-on-cardano-and-interview-with-patrick-tobler-from-nft-maker-io"
date: "2021-04-20"
categories: ["Learn Cardano Podcast"]
excerpt: ""
metaDescription: "EP004 Non Fungible Tokens on Cardano and Interview with Patrick Tobler from NFT-Maker.io"
ogTitle: "EP004 Non Fungible Tokens on Cardano and Interview with Patrick Tobler from NFT-Maker.io"
...
-   [EIP-2565: ModExp Gas Cost](https://eips.ethereum.org/EIPS/eip-2565)
    -   reduce the cost of the ModExp precompile. This will help calculate the gas prices.
-   [EIP-2929: Gas cost increases for state access opcodes](https://eips.ethereum.org/EIPS/eip-2929)
    -   will ‘increase’ certain gas costs when used for the first time in a transaction.;
-   [EIP-2718: Typed Transaction Envelope](https://eips.ethereum.org/EIPS/eip-2718)
    -   will introduce a new transaction module that will support multiple transactions;
-   [EIP-2930: Optional access lists](https://eips.ethereum.org/EIPS/eip-2930)
    -   will transaction type with optional access lists. This particular EIP will help alleviate some of the newly imposed gas prices from EIP-2929.

You can read more about [Ethereum's Berlin Update](https://blog.ethereum.org/2021/03/08/ethereum-berlin-upgrade-announcement/) from their official announcement or from [Yahoo Finance's article](https://finance.yahoo.com/news/ethereum-berlin-upgrade-includes-fixes-150000940.html) about the upgrade.
...
Over the weekend we saw a massive drop in the cryptocurrency markets and rumours in regards to what the cause could have been. The most plausible that I've discovered related to [Bitcoins Hashrate which dropped due to a blackout in Xinjiang province](https://coinmarketcap.com/headlines/news/chinas-xinjiang-blackout-and-bitcoin-hashrate-correction-caused-btc-price-crash/) in China. There is a direct correlation to the hash rate which is produced to validate and Bitcoins price.
...
![](/uploads/2021/04/EzPJghMVcAEhvqL-800x360.jpeg)

Bitcoins hash rate drop in 2017

> Price and hash rate has always been correlated.  
>   
> This is BTC price vs today's hash rate collapse (from the Xinjiang blackout). [pic.twitter.com/mywEZLHlA0](https://t.co/mywEZLHlA0)
> 
> — Willy Woo (@woonomic) [April 18, 2021](https://twitter.com/woonomic/status/1383672529995190281?ref_src=twsrc%5Etfw)
...
You can [follow Patrick on Twitter](https://twitter.com/Padierfind) and you can create an NFT on his website [NFT-Maker.io](https://www.nft-maker.io/).

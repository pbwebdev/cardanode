---
title: "EP002 - Chat with Mat from EcoPool.io & Proof of Work vs Proof of Stake"
slug: "ep002-chat-with-mat-from-ecopool-io-proof-of-work-vs-proof-of-stake"
date: "2021-04-06"
categories: ["Learn Cardano Podcast"]
excerpt: ""
metaDescription: "EP002 - Chat with Mat from EcoPool.io & Proof of Work vs Proof of Stake"
ogTitle: "EP002 - Chat with Mat from EcoPool.io & Proof of Work vs Proof of Stake"
...
CardanoBits is another creative project built similarly to [SpaceBudz](http://cardanode.com.au/spacebuds-yes-i-got-one-tradeable-nft-on-cardano/) with 10000 CardanoBits characters minted and all sold out in 50 minutes. There were a few hiccups along with server issues and even Yoroi timeout issues. Definitely not the smoothest experiences as described by a few users but never the less another exciting release on Cardano.

> Wow! Yesterday traffic on Yoroi jumped multiple times standard traffic in just a few minutes up to ~600 requests/sec!  
>   
> Nobody expected the NFT sale to bring in 100s of txs per block. Going forward, we can better predict these traffic jumps during NFT sales and pre-emptively act
> 
> — Yoroi Wallet (@YoroiWallet) [April 5, 2021](https://twitter.com/YoroiWallet/status/1379069508397109250?ref_src=twsrc%5Etfw)

-   Technical breakdown of [how the SpaceBudz NFT sale was executed](https://spacebudz.medium.com/how-we-pulled-off-the-sale-9dbe54c30ba5).
...
![Bitcoins annualised power consuption](/uploads/2021/04/bitcoin-current-power-usage.png)

Statistics from the University of Cambridge
...
![](/uploads/2021/04/bitcoin-power-uage-comparison-to-countries-800x313.png)

The entire country of Ukraine uses 128 TWh, Sweden uses 131.9 TWh, Malaysia uses 147.21 TWh and Egypt uses 150.58 TWh. To power Bitcoin, we need the equivalent power usage as these countries. This is extremely unsustainable and costly to the environment. Countries like China have started to [ban the mining of cryptocurrencies](https://www.cnbc.com/2021/03/02/china-bitcoin-mining-hub-to-shut-down-cryptocurrency-projects.html) in certain regions because of this high energy usage.
...
In comparison, the Cardano network can run off low power computers such as Raspberry Pis and consume as little as 30 watts of power for a complete stake pool set up. Charles Hoskinson has been quoted stating that the entire Cardano Proof of Stake network [consumes as little as 6](https://www.cnbc.com/2021/02/05/bitcoin-btc-surge-renews-worries-about-its-massive-carbon-footprint.html) [](https://www.cnbc.com/2021/02/05/bitcoin-btc-surge-renews-worries-about-its-massive-carbon-footprint.html)[GWh](https://www.cnbc.com/2021/02/05/bitcoin-btc-surge-renews-worries-about-its-massive-carbon-footprint.html) or 56.56 TWh per year. This is still a large amount of power but a fraction of what is required compared to Bitcoin and due to the non-specialised hardware, operators of these stake pools can easily run it at home on solar power or other renewable sources.
...
You can find out more about Mat and his pool at [EcoPool.io](https://EcoPool.io) or you can follow him on Twitter [@EcoPool\_io](https://twitter.com/EcoPool_io). If you wish to delegate to Mat's pool, ensure you're using the correct pool ID as there is a second pool with the same name, ticker \[ECO\].

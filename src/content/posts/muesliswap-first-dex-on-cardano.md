---
title: "MuesliSwap, 1st Decentralised Exchange on Cardano"
slug: "muesliswap-first-dex-on-cardano"
date: "2021-12-23"
categories: ["DeFi"]
excerpt: ""
metaDescription: "MuesliSwap, 1st Decentralised Exchange on Cardano"
ogTitle: "MuesliSwap, 1st Decentralised Exchange on Cardano"
ogImage: "/uploads/2021/12/muesliswap-order-book-800x450.jpg"
youtube: ["https://www.youtube.com/embed/6ca-u7ofC1Q"]
---
...
![MuesliSwap Decentralised Exchange Order Book view](/uploads/2021/12/muesliswap-order-book-800x450.jpg)

## Back Story

In digging into the development of the DEX, there were several clues as to how the DEX may have been built so quickly.

The team have built a working DEX on [SmartBCH](https://smartbch.org/) which is an EVM based sidechain that allows for Solidity based smart contracts. This experience with building a DEX, working with another UTXO blockchain and an EVM sidechain may have been an easy transition for their team to transition their knowledge from the Bitcoin Cash DEX to the Cardano DEX.

## MuesliSwap Plutus Script

At the time of writing this article, the number of times the MuesliSwap Plutus scripts have been executed now exceeds 44,000. The data can be [viewed at Cardano Block Insights](https://datastudio.google.com/u/0/reporting/3136c55b-635e-4f46-8e4b-b8ab54f2d460/page/p_7d0otw5xpc).

On the 12th of December 2021, the [number of executions of the MuesliSwap script](https://twitter.com/RichardMcCrackn/status/1470073514573107211?s=20) was 11,500 executions.

![](/uploads/2021/12/muesliswap-transactions-800x450.jpg)

You can [view the script on CardanoScan](https://cardanoscan.io/address/7115b95fdaceeb507073a1bd198803373beeafbd82560fbf8abe9073ff).
...
[![](/uploads/2021/12/muesliswap-code-800x450.jpg)](https://github.com/MuesliSwapTeam)
...
You can see all of their code on their [GitHub repositories](https://github.com/MuesliSwapTeam).
...
![](/uploads/2021/12/muesliswap-tokenomics-800x450.jpg)
...
You can find out more details about the [Cardano MuesliSwap tokenomics](https://docs.muesliswap.com/cardano/ada-milk-tokenomics).

## Find Out More

You can find out more about the project via all their website and their social channels.

-   Website [https://muesliswap.com](https://muesliswap.com)
-   [Twitter](https://twitter.com/MuesliSwapTeam)
-   [Discord](https://discord.gg/2BAHJmR8vK)
-   [Telegram](https://t.me/Muesliswapofficial)

Other decentralised exchanges worth looking at include [Genius Yield](http://cardanode.com.au/genius-yield-automated-yield-optimiser/) with their automated yield optimiser.

---
title: "How to Easily Delegate ADA to a Stake Pool with Daedalus in 4 Quick Steps"
slug: "delegate-ada-stake-pool-daedalus"
date: "2021-02-25"
categories: ["Daedalus"]
excerpt: "Staking your ADA to get rewards is the backbone of the Cardano network. The proof of stake protocol allows users to be rewarded in ADA for helping to validate blocks on the network, similar to how Bitcoin and Ethereum validate their networks with mining, rewarding miners in their respective tokens."
metaDescription: "Staking your ADA to get rewards is the backbone of the Cardano network. The proof of stake protocol allows users to be rewarded in ADA for helping to valid"
ogTitle: "How to Easily Delegate ADA to a Stake Pool with Daedalus in 4 Quick Steps"
ogImage: "/uploads/2021/02/adaoz-on-daedalus.png"
youtube: []
---
...
![Delegate ADA on Daedalus](/uploads/2021/02/adaoz-on-daedalus.png "Delegate ADA")

Delegate ADA on Daedalus

## Download, Install & Create a Daedalus Wallet

Firstly, [download the Daedalus](https://daedaluswallet.io/) and create a wallet.  
...
In the search bar, type in the pool name that you want to delegate ADA towards.  
...
4\. Daedalus Wallet (Desktop)  
5\. Yoroi Wallet (Browser extension, Mobile)  
6\. ADALite (Browser)  
  
We have done a review on the [best wallets for Cardano](http://cardanode.com.au/best-wallet-for-cardano-ada/).

### How Much ADA Do You Need to Stake?

The minimum amount of ADA that you will need to stake from Daedalus is 5 ADA + transaction fee but you will find that it will take a very long time to recover the ADA that you have used for transfer fees to get it to a wallet.  
  
I would personally recommend not transferring and delegating anything less than 100 ADA purely because of the time it takes to recover the ADA from transfer and wallet delegation registration.

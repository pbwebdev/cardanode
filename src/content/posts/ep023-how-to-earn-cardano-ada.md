---
title: "EP023 - Earn Cardano (ADA) in 3 Easy Ways"
slug: "ep023-how-to-earn-cardano-ada"
date: "2021-08-31"
categories: ["Learn Cardano Podcast"]
excerpt: ""
metaDescription: "EP023 - Earn Cardano (ADA) in 3 Easy Ways"
ogTitle: "EP023 - Earn Cardano (ADA) in 3 Easy Ways"
ogImage: "/uploads/2021/08/earn-Cardano-ADA-800x533.jpg"
youtube: ["https://www.youtube.com/c/NFTUpdate/"]
---
<iframe class="podcast-embed" src="https://widget.spreaker.com/player?episode_id=46310862&theme=light&playlist=false&playlist-continuous=false&autoplay=false&live-autoplay=false&chapters-image=true&episode_image_position=right&hide-logo=false&hide-likes=false&hide-comments=false&hide-sharing=false&hide-download=true" width="100%" height="200" frameborder="0" loading="lazy"></iframe>

![Learn how to earn Cardano (ADA)](/uploads/2021/08/earn-Cardano-ADA-800x533.jpg)

Learn how to earn Cardano (ADA)

In this episode and shote notes, we learn how to earn Cardano rather than continuously converting fiat currencies for ADA. In episode 22, we looked into [how much ADA you need to retire](http://cardanode.com.au/ep022-how-to-retire-on-ada-cardano/). For some people, it still seems impossible to get enough ADA soon enough to retire and it bought up a lot of questions and FOMO (Fear of Missing Out).
...
One really interesting launch that I'm monitoring is [CardanoCity](https://twitter.com/cardanocity).

https://twitter.com/CardanoCity/status/1423791990119010306?s=20

It's a mysterious NFT drop where we have only seen a handful of images from a Twitter account. They're stunning images generated in a futuristic cyberpunk metaverse. No one knows who is working on the project, no one knows any details of the project other than there is a website where the NFT might be dropped from, [cardanocity.io](https://cardanocity.io). It should be released 12 hours after this podcast episode is released.

![](/uploads/2021/08/cc_soon-800x490.jpg)

Cardano City landing page image
...
![Unsigned Algorithms or Unsigs - Cardano NFT](/uploads/2021/08/unsigs-800x400.jpg)

Unsigned Algorithms or Unsigs
...
Check out their [Discord community](https://discord.com/invite/JU7pD47v59) where collectors are now mashing together their collections creating deeper NFTs.
...
The easiest by far is [NFT-Maker.io](https://NFT-Maker.io). I [interviewed Patrick Tobler in episode 4](http://cardanode.com.au/ep004-non-fungible-tokens-on-cardano-and-interview-with-patrick-tobler-from-nft-maker-io/) about his platform and its future development.

To use the platform, upload a valid image file and fill in the form details.

![](/uploads/2021/08/nft-maker-io.create-nft-800x482.jpg)

Creating an NFT on NFT Maker
...
The NFT can be visually [viewed on Pool.pm](https://pool.pm/e922a037b428eeecb1e3c62089460c16bba1e32eacf6b58ac6e29b74.SnowManAmirasFirstNFT).

## Selling a Cardano NFT

![CNFT Marketplace](/uploads/2021/08/cnft-marketplace.jpg)

CNFT Marketplace

The selling part is the trickier part at this point in time as there aren't mature marketplaces to sell Cardano NFTs.

The majority of the NFT community across multiple different blockchains have thriving Discord communities where NFTs are auctioned and traded between users with escrow services.

There are also a handful of Cardano NFT marketplaces that allow for the listing and auctioning off an NFT. The most notable is [CNFT.io](http://CNFT.io) where you can sell and earn Cardano.

You can view [Amira's NFT](https://cnft.io/token.php?id=ZMOAysQ36BADRsmYHMJX) which has been listed for sale on the CNFT.io website. Buy her NFT and help here earn Cardano (ADA). :D

The best place to sell an NFT and earn Cardano at the moment is via Discord and CNFT.io (when it is working).

-   [SpaceBudz Discord Server](https://discord.gg/eJX7xWxYg5)
-   [CryptoFly777 Discord Server](https://discord.gg/9gsRG9p9AR)
-   [Flowers Auction House](https://discord.gg/VCmPUS2QAA)

## Learning More About Cardano's NFT Community
...
A really great YouTube channel that covers many of the Cardano NFT projects is [NFTUpdate](https://www.youtube.com/c/NFTUpdate/) Show. Be sure to check them out and subscribe to their content to learn more about these emerging NFT projects, let them know you've come from the Learn Cardano Podcast.

-   [NFTUpdate on YouTube](https://www.youtube.com/c/NFTUpdate/)
-   [NFTUpdate on Twitter](https://twitter.com/NFTUpdateIO)
...
-   [How to setup a WooCommerce site](https://woocommerce.com/posts/how-to-set-up-a-new-woocommerce-store/)
-   [Starting with WooCommerce in 5 easy steps](https://docs.woocommerce.com/document/start-with-woocommerce-in-5-steps/)
...
![Accepting Cryptocurrencies with NOWPayments](/uploads/2021/08/NOWPayments-800x400.jpg)

Accepting Cryptocurrencies with NOWPayments

[NOWPayments](https://nowpayments.io/) is the current gateway that is being used on the podcast website where I'm currently selling hoodies, t-shirts socks and stickers based on artwork that we have created or own.
...
![Accept ADA Payments on WooCommerce with Mercury
](/uploads/2021/08/mercury_banner-800x400.jpg)

Accept ADA Payments on WooCommerce with Mercury

[Mercury](https://github.com/cardano-mercury/cardano-mercury-woocommerce) is an open-source project that allows for the acceptance of ADA directly to a wallet address via WooCommerce.
...
![](/uploads/2021/08/cardano-ada-hoodie-800x584.jpg)

Check out our merchandise on the Merch page

## BONUS - Earn Cardano (ADA) by Becoming a part of the Project Catalyst Ecosystem

![](/uploads/2021/09/project-catalyst.webp)

Contribute to Project Catalyst and the Cardano ecosystem to earn Cardano ADA
...
1.  Proposal and project submissions
2.  Catalyst Advisors
3.  Referrers to the ecosystem
...
If you'd like to learn more about Project Catalyst and how the ecosystem works around governance for Cardano, please listen to episode 3 where I cover [everything you need to know about Project Catalyst](http://cardanode.com.au/ep003-cardanos-project-catalyst-what-is-it-how-to-contribute-how-to-participate/).

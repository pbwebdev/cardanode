---
title: "EP003 - Cardano's Project Catalyst, What is it, How to Contribute & How to Participate"
slug: "ep003-cardanos-project-catalyst-what-is-it-how-to-contribute-how-to-participate"
date: "2021-04-13"
categories: ["Learn Cardano Podcast"]
excerpt: ""
metaDescription: "EP003 - Cardano's Project Catalyst, What is it, How to Contribute & How to Participate"
ogTitle: "EP003 - Cardano's Project Catalyst, What is it, How to Contribute & How to Participate"
ogImage: ""
youtube: ["https://www.youtube.com/watch?v=Pjg_u7Oeel0", "https://www.youtube.com/watch?v=QdiciXRnVkQ&amp;list=PLfUWWM-POgQvknM0gQ9St9vR5i-x9ac9P&amp;index=4&amp;t=1s", "https://www.youtube.com/watch?v=QdiciXRnVkQ\\u0026list=PLfUWWM-POgQvknM0gQ9St9vR5i-x9ac9P\\u0026index=4\\u0026t=1s", "https://www.youtube.com/watch?v=WcI-ZvyeRd8&amp;t=6s", "https://www.youtube.com/watch?v=WcI-ZvyeRd8\\u0026t=6s", "https://youtu.be/QdiciXRnVkQ"]
---
...
> 1/ This is a very sad day for me and for [@insaladaPool](https://twitter.com/insaladaPool?ref_src=twsrc%5Etfw). Long story short: my most important digital life files are forever gone. Everything SALAD, [#Cardano](https://twitter.com/hashtag/Cardano?src=hash&ref_src=twsrc%5Etfw), Daedalus, Yoroi, Ledger, Trezor, GPG, SSH, 2FA recovery codes, and more. All gone. [#CardanoCommunity](https://twitter.com/hashtag/CardanoCommunity?src=hash&ref_src=twsrc%5Etfw) [#ada](https://twitter.com/hashtag/ada?src=hash&ref_src=twsrc%5Etfw) [$ada](https://twitter.com/search?q=%24ada&src=ctag&ref_src=twsrc%5Etfw)
> 
> — ? Insalada Stake Pool - SALAD ?? (@insaladaPool) [April 8, 2021](https://twitter.com/insaladaPool/status/1380087586509709312?ref_src=twsrc%5Etfw)
...
-   [@spacebudzNFT](https://twitter.com/spacebudzNFT)
-   [@Cryptofly777](https://twitter.com/Cryptofly777)
-   [@CardanoBits](https://twitter.com/CardanoBits)
-   [@Cryptiesnft](https://twitter.com/cryptiesnft)
-   [@cryptoknitties](https://twitter.com/cryptoknitties)
-   [@adadolls](https://twitter.com/AdaDolls)
-   [@CardanoFc](https://twitter.com/CardanoFc)
-   [@adazooNFT](https://twitter.com/adazooNFT)
-   [@cryptomayorNFT](https://twitter.com/cryptomayorNFT)
-   [@ProfesCardano](https://twitter.com/ProfesCardano)
-   [@CardanoKidz](https://twitter.com/CardanoKidz)
-   [@CNFT\_IO](https://twitter.com/CNFT_IO)
-   [@LocoAdaPool](https://twitter.com/LocoAdaPool)
-   [@CardanoGods](https://twitter.com/CardanoGods)
-   [@ADAbirdsNFT](https://twitter.com/ADAbirdsNFT)
-   [@The\_ClayMates](https://twitter.com/The_ClayMates)
-   [@MADinArt3](https://twitter.com/MADinArt3)
-   [@cryptocapitalmx](https://twitter.com/cryptocapitalmx)
-   [@boba\_bits](https://twitter.com/boba_bits)
-   [@cardanogang](https://twitter.com/cardanogang)
-   [@jetchickenNFT](https://twitter.com/jetchickenNFT)
-   [@Flawwed1Art](https://twitter.com/Flawwed1Art)
-   [@StigmaNFT](https://twitter.com/StigmaNFT)
-   [@the\_hoskinsons](https://twitter.com/the_hoskinsons)
-   [@Red\_Palm\_prod](https://twitter.com/Red_Palm_prod)
-   [@blizzeffect](https://twitter.com/blizzeffect)
-   [@nftynfty](https://twitter.com/nftynfty)
-   [@BOOM\_POPZ](https://twitter.com/BOOM_POPZ)

### NFT Maker

Patrick Tobler from [NFT-maker.io](https://www.nft-maker.io/) has put together a quick and easy way to create an NFT with no technical skill. Feel free to experiment and explore how NFTs work on Cardano.

### [CNFT.IO](https://www.cnft.io/) \- Digital Token Platform
...
To understand Project Catalyst I decided to go to the source of where it all began, and that is with the research paper published by [Bingsheng Zhang](https://www.lancaster.ac.uk/staff/zhangb2/), [Roman Oliynykov](https://iohk.io/en/team/roman-oliynykov) and [Hamed Balogun](https://www.researchgate.net/profile/Hamed-Balogun) in Feb 2019. Their research references the proposal of another 48 articles and papers from other projects including Ethereum Classic and Dash.

You can read the [full research paper](https://iohk.io/en/research/library/papers/a-treasury-system-for-cryptocurrenciesenabling-better-collaborative-intelligence/) at the IOHK research library.

You can watch [Bingsheng Zhang's presentation](https://youtu.be/QdiciXRnVkQ) at the Network and Distributed System Security Symposium in 2019.

https://www.youtube.com/watch?v=QdiciXRnVkQ&list=PLfUWWM-POgQvknM0gQ9St9vR5i-x9ac9P&index=4&t=1s

Bingsheng Zhang presenting at NDSS 2019 on a Treasury System for Cryptocurrencies: Enabling Better Collaborative Intelligence

https://www.youtube.com/watch?v=WcI-ZvyeRd8&t=6s

Dr Dor Garbash on implementing the governance model for Cardano
...
> Treasury funding, perhaps is the most crucial ingredient in a decentralised community-controlled decision-making system. It must not only be regular, but also sourced from decentralised means.
> 
> A Treasury System for Cryptocurrencies: Enabling Better Collaborative Intelligence: 3.4 Treasury funding sources

Bitcoin's development and funding comes from the [Bitcoin foundation](https://bitcoinfoundation.org/). It derives its funding from donations from miners and the community and memberships. If this source dried up, then the development and maintenance of Bitcoin may stop. Miners are the ones that are incentivised to mine Bitcoin and are rewarded with Bitcoin when they produce blocks. Developers who write and maintain the code don't get anything for their efforts.
...
https://www.youtube.com/watch?v=Pjg\_u7Oeel0

Regular town hall presentation on Project Catalyst
...
You can join the [Catalyst Community Advisors Telegram channel](https://t.me/CatalystCommunityAdvisors) to learn more about the process and onboarding to become an advisor.
...
You can read my own submission on [WooCommerce & Other Ecom Integration to accept ADA payment gateway](https://cardano.ideascale.com/a/dtd/WooCommerce-Other-ecom-integratio/351487-48088) and provide feedback on IdeaScale.

There is a complete [FAQ guide](https://docs.google.com/document/d/1qYtV15WXeM_AQYvISzr0a0Qj2IzW3hDvhMBvZZ4w2jE/edit#heading=h.dmu4wfbk1ion) and [proposal writing guide](https://docs.google.com/document/d/1oE_cnP0gksdAanXV4w5DYaDNp_tbYEvyHhTUG4HYZ3Q/edit?disco=AAAAG42-Ypk&ts=5f4ffe33&usp_dm=true) provided by IOHK.
...
-   [AdaPulse Reviews of Various Project Proposal Submissions](https://adapulse.io/category/project-reviews/)
-   [Cardano IdeaScale](https://cardano.ideascale.com)
-   [Catalyst Community Advisor Telegram group](https://t.me/CatalystCommunityAdvisors)
-   [My WooCommerce Payment Gateway Proposal](https://cardano.ideascale.com/a/dtd/WooCommerce-Other-ecom-integratio/351487-48088)
-   [Emurgo's article about Cardano's Treasury System](https://www.emurgo.io/en/blog/what-makes-the-cardano-blockchain-treasury-system-special)
-   [The Cardano Effect Podcast](https://thecardanoeffect.libsyn.com/) - Breaks down a few proposals and ideas in Project Catalyst, unfortunately, no longer recording.

---
title: "EP025 - Building on Cardano with Smart Contracts"
slug: "ep025-building-on-cardano-with-smart-contracts"
date: "2021-09-14"
categories: ["Learn Cardano Podcast"]
excerpt: ""
metaDescription: "EP025 - Building on Cardano with Smart Contracts"
ogTitle: "EP025 - Building on Cardano with Smart Contracts"
...
A nice way to see everything at a glance is with an infographic produced by @cardains\_

![](/uploads/2021/09/E-FiW5PVIAA_FEJ-800x450.jpeg)

May 26th 2021

![](/uploads/2021/09/E-FhuJoUUAEP9V8-800x450.jpeg)
...
One interesting project that isn't on the list is [ADAHandle](https://adahandle.com/), this allows you to claim a handle or username to be able to accept ADA. Instead of providing a long wallet address, you will be able to provide a short human-readable handle that will translate into a wallet address and allow for transfers to the handle instead of a lengthy was llet address. at the moment you can reserve your handle.

The Team at [5iveBinaries](https://twitter.com/fivebinaries?s=20) were the first to execute a smart contract on Cardano.

https://twitter.com/stakenuts/status/1437203430313975808?s=20

In a recent tweet, we've also seen the execution of NFT traded by a smart contract on testnet.

https://twitter.com/spacebudzNFT/status/1435690072112775170?s=20

Successful smart contract trade on testnet
...
Ethereum uses solidity as its smart contract language. Solidity is designed to be similar to JavaScript, a common web programming language to help reduce the learning curve for new developers. It allows the onboarding of developers easily to the ecosystem. Any good Javascript developer can easily pick up Solidity and start developing smart contracts for Ethereum and Binance Smart Chain.   
...
-   [Plutus Pioneer documentation](https://plutus-pioneer-program.readthedocs.io/en/latest/pioneer/week1.html)
-   [Github to Plutus video lectures](https://github.com/input-output-hk/plutus-pioneer-program)

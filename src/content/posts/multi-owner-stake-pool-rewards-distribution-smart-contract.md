---
title: "Multi Owner Stake Pool Rewards Distribution Smart Contract"
slug: "multi-owner-stake-pool-rewards-distribution-smart-contract"
date: "2021-03-27"
categories: ["Stake Pool Operators"]
excerpt: ""
metaDescription: "Multi Owner Stake Pool Rewards Distribution Smart Contract"
ogTitle: "Multi Owner Stake Pool Rewards Distribution Smart Contract"
ogImage: ""
youtube: []
---
## Problem
...
Owner 1: 1000 ADA (Main Operator)  
Owner 2: 5000 ADA  
Owner 3: 2000 ADA  
Owner 4: 2000 ADA  
Total ADA in pledge: 10,000
...
Based on their percentage stake in the pool, when the 1000 ADA is sent to the pools rewards wallet, it is divided up accordingly and sent to the corresponding wallets of the owners. This could be the wallet that is set on the pools pledge or a secondary wallet which the have access to.
...
Since at the time of writing this proposal, smart contracts are not yet available on Cardano but is roughly 3-4 months away.

I'm currently coding up the contract and testing on the Plutus playground and will provide a code commit when it looks read for testing and feedback. In the meantime, any feedback on the concept would be appreciated.

This [README](https://github.com/pbwebdev/stake-pool-multi-owner-reward-distribution-contract) and initial commit can be found on [Github](https://github.com/pbwebdev/stake-pool-multi-owner-reward-distribution-contract).

## Frequently Asked Questions

### How Can I Contribute?

Jump on Github, create issues, fork the project idea, make a pull request or just contact me on Twitter [@cardanodeau](https://twitter.com/cardanodeau) or [@astroboysoup](https://twitter.com/astroboysoup)

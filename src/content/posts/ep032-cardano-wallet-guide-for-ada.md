---
title: "EP032 - Best Cardano Wallet Guide"
slug: "ep032-cardano-wallet-guide-for-ada"
date: "2021-11-09"
categories: ["Learn Cardano Podcast", "Wallets"]
excerpt: ""
metaDescription: "EP032 - Best Cardano Wallet Guide"
ogTitle: "EP032 - Best Cardano Wallet Guide"
ogImage: "/uploads/2021/11/sundaeswap-website-screenshot-800x450.jpg"
youtube: ["https://www.youtube.com/embed/N1NGsuXZBGo"]
---
A Cardano wallet is usually the first thing you would set up when entering the Cardano ecosystem.

\[spreaker type=player resource="episode\_id=47390801" width="100%" height="200px" theme="light" playlist="false" playlist-continuous="false" chapters-image="true" episode-image-position="right" hide-logo="false" hide-likes="false" hide-comments="false" hide-sharing="false" hide-download="true"\]
...
![SundaeSwap ISO Cardano DEX token](/uploads/2021/11/sundaeswap-website-screenshot-800x450.jpg)

SundaeSwap ISO Cardano DEX token

Check out all the FAQs and details around the [SundaeSwap ISO](http://cardanode.com.au/sundaeswap-iso-complete-guide-sundae-tokens/).
...
![Cardano hardware wallets](/uploads/2021/11/cardano-hardware-wallets-800x450.jpg)
...
-   [Ledger Nano](https://shop.ledger.com?r=d7cc) (affiliate link)
...
![Cardano wallet ecosystem](/uploads/2021/11/cardano-wallets-1-800x450.jpg)

Cardano wallet ecosystem

There are so many wallets being created at the moment that it is hard to keep up with the Cardano wallet development and all the decentralised finance protocols being built simultaneously.

This is a selection of the most popular and widely used wallets in the Cardano wallet ecosystem.

-   [Cardano Daedalus Wallet](https://daedaluswallet.io/)
...
-   [CardWallet](https://www.cardwallet.fi/)
-   [Eternl](https://ccvault.io/app/welcome)
-   [Nami](https://namiwallet.io/)
-   [Ray Wallet](https://app.raywallet.io/)
...
Although these apps are fantastic onboarding rails for new users and purchasing cryptocurrencies, they are custodial wallets. You, the owner, do not control the seed phrases; therefore, the assets are not truly under your control.

This is a trade-off between security and convenience of not having to maintain a seed phrase and securing that.

If you want to create your own Cardano wallet app, that is very well possible for any developer. The [Cardano wallet API](https://input-output-hk.github.io/cardano-wallet/api/edge/) is well documented and accessible online via the Cardano-wallet Github.
...
Any Cardano wallet can be restored on another Cardano wallet app. If you are using Yoroi, you can use that seed phrase and restore it on Daedalus or NuFi. If the wallet you're using supports hardware wallets, you can also restore your hardware wallet on any of these wallet apps.
...
Follow our guide to [obtaining your unique stake key](http://cardanode.com.au/how-to-find-your-cardano-stake-key/) to help identify your wallet.

## Viewing CNFTs

![Cardano NFT Wallet Viewer](/uploads/2021/11/nft-mobile-cardano-wallets-800x450.jpg)

Cardano NFT Wallet Viewer

If you're a Cardano Non-Fungible Token collector (CNFT), you would most likely want a wallet where you can show off your NFTs and share it with your peers. There is nothing like flexing an original collection of SpaceBudz or using it as a pickup line ? (let me know if you have).

## Cardano Wallets of the Next Generation: Cardano Web3 Wallets

![Nami Wallet, a Web3 Cardano Wallet](/uploads/2021/11/web3-dapp-cardano-wallet-nami-800x450.jpg)
...
<iframe src="https://www.youtube.com/embed/N1NGsuXZBGo" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
